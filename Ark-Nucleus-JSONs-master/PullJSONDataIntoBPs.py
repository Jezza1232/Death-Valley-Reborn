...
with open("E:\\GitRepos\\ArkModding\\Ark-Nucleus-JSONs\\widgets\\base-widget\\inventory-button.json","r", encoding="utf8") as jsonFile:
    jsonData = json.load(jsonFile)
    change_blueprint_default_value("/Ark-Nucleus/SharedContent/Widgets/PauseMenu/Nucleus_W_InventoryButtons.Nucleus_W_InventoryButtons_C", "N_BaseWidget_StaticUIConfig", json.dumps(jsonData))
